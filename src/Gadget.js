...
export const Gadget = [
...

  {
    ...
    description: `
        ...
        **Features:**  
        - **:** 24 x 10/100/1000 Gigabit Ethernet ports, 2 x 10G SFP+ uplink ports  
...

  {
    ...
    cartQuantity: 1,
    category: ["Networking", "Wired Networking", "Switches", "Cisco"],
    currency: "NGN",
    specification: [
      {
        id: 1,
  ...
  **Installation:**  
  ...
  //  categories: ["Networking", "Wired Networking", "Switches", "Cisco"],
  //   currency: "NGN",
  //   description: "The Cisco Catalyst 2960-Plus Series Switches are fixed-configuration Fast Ethernet switches that provide enterprise-class Layer 2 switching for branch offices, conventional workspaces, and infrastructure applications. They enable reliable and secure operations with lower total cost of ownership through a range of Cisco IOS software features, including Cisco Catalyst SmartOperations.\n\nProduct Highlights:\n- 24 Fast Ethernet ports\n- Small Form-Factor Pluggable (SFP) and 1000BASE-T Gigabit Ethernet uplinks\n- IEEE 802.3af-compliant Power over Ethernet (PoE)\n- LAN Lite Cisco IOS Software feature set\n- SmartOperations tools to simplify deployment and reduce the cost of network administration\n- Cisco EnergyWise technology to manage energy consumed by connected devices\n- Enhanced limited lifetime hardware warranty (E-LLW) with next-business-day replacement",
  ...
  //   images: [all],
  //   manufacturer: "Cisco",
  //   manufacturerPartNumber: "WS-C2960+24PC-S",
  //   slug: "cisco-ws-c2960-24pc-s-catalyst-2960-24ports-370w-poe-switch-2-x-sfp-lan-lite",
  //   specifications: `
  //     {
  //       "key": "Product Type",
  //       "value": "Fixed-Configuration Fast Ethernet Switch"
  //     },
  //     {
  //       "key": "Ports",
  //       "value": "24 x Fast Ethernet Ports, 2 x SFP Uplink Ports"
  //     },
  //     {
  //       "key": "PoE Power",
  //       "value": "370W total POE Power"
  //     },
  //     {
  //       "key": "Switching Capacity",
  //       "value": "N/A"
  ...
  //     {
  //       "key": "Power Over Ethernet (PoE)",
  //       "value": "Supports IEEE 802.3af PoE"
  //     },
  //     {
  //       "key": "Security Features",
  //       "value": "Port Security, Dynamic ARP Inspection, IP Source Guard, Private VLAN Edge"
  //     },
  //     {
  //       "key": "Quality of Service (QoS)",
  //       "value": "Four egress queues per port, strict priority queuing, Shaped Round Robin (SRR) scheduling, Weighted Tail Drop (WTD) congestion avoidance"
  //     },
  //     {
  //       "key": "Energy Efficiency",
  //       "value": "Cisco EnergyWise Technology"
  //     },
  //     {
  //       "key": "Dimensions",
  //       "value": "44.45 mm x 297.18 mm x 259.08 mm"
  //     },
  //     {
  //       "key": "Weight",
  //       "value": "4.97 kg"
  ...
  //     {
  //       "key": "Compliance Standards",
  //       "value": "IEEE 802.3, IEEE 802.3u, IEEE 802.3af, IEEE 802.1x, IEEE 802.1p"
  //     },
  //     {
  //       "key": "Mounting Options",
  //       "value": "Rack-mountable"
  //     },
  //     {
  //       "key": "Management",
  //       "value": "LAN Lite Cisco IOS Software, SmartOperations"
  //     },
  //     {
  //       "key": "Operating Temperature",
  //       "value": "32 to 113 deg. F (0 to 45 deg. C)"
  //     },
  //     {
  //       "key": "Storage Temperature",
  //       "value": "-4 to 158 deg. F (-20 to 70 deg. C)"
  //     },
  //     {
  //       "key": "Operating Humidity",
  //       "value": "10% to 85%, non-condensing"
  //     },
  //     {
  //       "key": "Storage Humidity",
  //       "value": "5% to 95%, non-condensing"
  //     }
  //   `,
  //       }
];
